...
package com.lwbd.lwbdpoc.lint

import com.android.tools.lint.checks.infrastructure.TestFile
import com.android.tools.lint.checks.infrastructure.TestFiles.kotlin
import com.android.tools.lint.checks.infrastructure.TestLintTask.lint
import com.lwbd.lwbdpoc.lint.TestMethodNameDetector.Companion.FORMAT
import com.lwbd.lwbdpoc.lint.TestMethodNameDetector.Companion.PREFIX
...
class TestMethodNameDetectorTest {
    ...
    @Test
    fun `detect prefix`() {
        lint().allowMissingSdk().issues(PREFIX)
            .files(
                JUNIT_TEST_STUB,
                kotlin(
                    """
    ...
    @Test
    fun `detect format`() {
        lint().allowMissingSdk().issues(FORMAT)
            .files(
                JUNIT_TEST_STUB,
                kotlin(
