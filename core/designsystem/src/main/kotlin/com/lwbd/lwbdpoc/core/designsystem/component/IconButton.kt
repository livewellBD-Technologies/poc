...
/**
 * Lwbd toggle button with icon and checked icon content slots. Wraps Material 3
 * [IconButton].
 *
        ...
        colors = IconButtonDefaults.iconToggleButtonColors(
            ...
            disabledContainerColor = if (checked) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = LwbdIconButtonDefaults.DISABLED_ICON_BUTTON_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun IconButtonPreview() {
    LwbdTheme {
        LwbdIconToggleButton(
            checked = true,
            onCheckedChange = { },
            icon = {
                Icon(
                    imageVector = LwbdIcons.BookmarkBorder,
                    contentDescription = null,
                )
            },
            checkedIcon = {
                Icon(
                    imageVector = LwbdIcons.Bookmark,
                    contentDescription = null,
                )
            },
        )
...
/**
 * Lwbd icon button default values.
 */
object LwbdIconButtonDefaults {
    // TODO: File bug
