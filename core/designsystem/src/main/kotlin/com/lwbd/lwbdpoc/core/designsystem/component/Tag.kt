    ...
    Box(modifier = modifier) {
        val containerColor = if (followed) {
            ...
            MaterialTheme.colorScheme.surfaceVariant.copy(
                alpha = LwbdTagDefaults.UNFOLLOWED_TOPIC_TAG_CONTAINER_ALPHA,
            )
        }
        TextButton(
            onClick = onClick,
            ...
            colors = ButtonDefaults.textButtonColors(
                ...
                disabledContainerColor = MaterialTheme.colorScheme.onSurface.copy(
                    alpha = LwbdTagDefaults.DISABLED_TOPIC_TAG_CONTAINER_ALPHA,
                ),
            ),
        ) {
...
fun TagPreview() {
    LwbdTheme {
        LwbdTopicTag(followed = true, onClick = {}) {
...
/**
 * Lwbd tag default values.
 */
object LwbdTagDefaults {
