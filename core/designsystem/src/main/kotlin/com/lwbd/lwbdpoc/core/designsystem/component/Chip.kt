...
/**
 * Lwbd filter chip with included leading checked icon as well as text content slot.
 *
    ...
    FilterChip(
        ...
        border = FilterChipDefaults.filterChipBorder(
            ...
            disabledBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = LwbdChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            disabledSelectedBorderColor = MaterialTheme.colorScheme.onBackground.copy(
                alpha = LwbdChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
            ),
            selectedBorderWidth = LwbdChipDefaults.ChipBorderWidth,
        ),
        colors = FilterChipDefaults.filterChipColors(
            ...
            disabledContainerColor = if (selected) {
                MaterialTheme.colorScheme.onBackground.copy(
                    alpha = LwbdChipDefaults.DISABLED_CHIP_CONTAINER_ALPHA,
                )
            } else {
                Color.Transparent
            },
...
fun ChipPreview() {
    LwbdTheme {
        LwbdBackground(modifier = Modifier.size(80.dp, 20.dp)) {
            LwbdFilterChip(selected = true, onSelectedChange = {}) {
                Text("Chip")
            }
        }
    }
...
/**
 * Lwbd chip default values.
 */
object LwbdChipDefaults {
    // TODO: File bug
