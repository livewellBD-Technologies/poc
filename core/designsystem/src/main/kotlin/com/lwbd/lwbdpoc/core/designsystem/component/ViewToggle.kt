...
/**
 * Lwbd view toggle button with included trailing icon as well as compact and expanded
...
fun LwbdViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = LwbdViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        LwbdViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) LwbdIcons.ViewDay else LwbdIcons.ShortText,
...
/**
 * Internal Lwbd view toggle button content layout for arranging the text label and
 * trailing icon.
 *
 ...
 */
@Composable
private fun LwbdViewToggleButtonContent(
...
/**
 * Lwbd view toggle default values.
 */
object LwbdViewToggleDefaults {
    // TODO: File bug
